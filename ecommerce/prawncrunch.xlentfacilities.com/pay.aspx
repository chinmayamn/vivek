...
<form  method="post" action="https://secure.ebs.in/pg/ma/sale/pay/" name="frmTransaction" id="frmTransaction" onSubmit="return validate()">	 
    <table width="600" cellpadding="2" cellspacing="2" border="0">
	   ...
	   <tr>
            ...
            <td  align="left" width="50%"> <input name="reference_no" type="text" value="12000" /></td>
        </tr>
        <tr>
            <td class="fieldName" width="50%">Sale Amount</td>
            <td  align="left" width="50%"> <input name="amount" type="text" value="1500" /> INR</td>
        </tr>
        <tr>
            <td class="fieldName" width="50%">Description</td>
            <td  align="left" width="50%"> <input name="description" type="text" value="TEST" /></td>
        </tr>
	    ...
	    <tr>
	    <input name="secure_hash" type="hidden" value="abcdefghijklmnopqrstuvwxyz012345" />
            <td class="fieldName"><span class="error">*</span> Name</td>
            <td align="left">
                <input name="name" type="text" value="Tinu" /></td>
        </tr>
       
        <tr>
            <td class="fieldName"><span class="error">*</span>Address</td>
            <td align="left">
                <input name="address" type="text" value="test" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                <input name="city" type="text" value="chennai" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
               <input name="state" type="text" value="TN" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                <input name="postal_code" type="text" value="600021" />
            </td>
        </tr>
...
<option value=""></option>
 ...
 <option value="ZWE">Zimbabwe</option>
		...
		<tr>
            <td class="fieldName"><span class="error">*</span> Name</td>
            <td align="left">
                <input name="ship_name" type="text" value="test" /></td>
        </tr>
       
        <tr>
            <td class="fieldName"><span class="error">*</span>Address</td>
            <td align="left">
                <input name="ship_address" type="text" value="test" />
            </td>
        </tr>
        ...
        <tr>
            <td class="fieldName"><span class="error">*</span>City</td>
            <td align="left">
                <input name="ship_city" type="text" value="chennai" />
            </td>
        </tr>
        ...
        <tr>
            <td class="fieldName">State/Province</td>
            <td align="left">
               <input name="ship_state" type="text" value="tamilnadu" />
            </td>
        </tr>
        ...
        <tr>
            <td class="fieldName"><span class="error">*</span>ZIP/Postal Code</td>
            <td align="left">
                <input name="ship_postal_code" type="text" value="600021" />
            </td>
        </tr>
...
<option value=""></option>
 ...
 <option value="ZWE">Zimbabwe</option>
        ...
        <tr>
            <td class="fieldName">Telephone</td>
            <td align="left"><input name="ship_phone" type="text" value="9865326598" /></td>
        </tr>

      <tr>
            <td class="fieldName">Return Url</td>
            <td align="left"><input name="return_url" type="text" size="60" value="http://localhost:2741/EBS-asp.net/response.aspx?DR={DR}" /> </td>
        </tr>
		<tr>
