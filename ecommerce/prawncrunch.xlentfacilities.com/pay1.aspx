...
<center>
 <table width='100%' cellpadding='0' cellspacing="0" ><tr><th width='90%'><h2 class='co'>&nbsp;EBS Payment Page</h2></th></tr></table>
	 <center><h3>Request Details</H3></center>
<form runat="server" method="post" action="https://secure.ebs.in/pg/ma/sale/pay/" name="frmTransaction" id="frmTransaction" onSubmit="return validate()">	 
    <table width="600" cellpadding="2" cellspacing="2" border="0">
	   <tr>
            <td class="fieldName" width="50%">Account Id</td>
            <td  align="left" width="50%"> <input name="account_id" type="text" value="9759" /></td>
        </tr>
        <tr>
	   ...
	   <tr>
            ...
            <td  align="left" width="50%">
                ...
                <asp:TextBox ID="reference_no" runat="server"></asp:TextBox>
        ...
        <tr>
            ...
            <td  align="left" width="50%"> <input name="description" type="text" value="Prawn buy" /></td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                <input name="postal_code" type="text" value="560085" />
            </td>
        </tr>
...
<option value=""></option>
 ...
 <option value="ZWE">Zimbabwe</option>
		...
		<tr>
            <td class="fieldName"><span class="error">*</span> Name</td>
            <td align="left">
                   <asp:TextBox ID="ship_name" runat="server"></asp:TextBox> 
        ...
        <tr>
            <td class="fieldName">State/Province</td>
            <td align="left">
                 <asp:TextBox ID="ship_state" runat="server"></asp:TextBox> 
            </td>
        </tr>
        ...
        <tr>
            <td class="fieldName"><span class="error">*</span>ZIP/Postal Code</td>
            <td align="left">
                <input name="ship_postal_code" type="text" value="560085" />
            </td>
        </tr>
 ...
 <option value="ZWE">Zimbabwe</option>
        ...
        <tr>
            ...
            <td align="left">
               ...
               <asp:TextBox ID="ship_phone" runat="server"></asp:TextBox> 
      ...
      <tr>
            ...
            <asp:TextBox ID="return_url" runat="server" size="60" ></asp:TextBox> 
