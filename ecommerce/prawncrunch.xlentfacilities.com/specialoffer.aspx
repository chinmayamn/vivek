<%@ Page Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="specialoffer.aspx.cs" Inherits="specialoffer"  %>
    	...
    	<div id="cont-mid">
        	<div id="content">
                ...
                <div id="right-nav1" >
                    ...
                    <ItemTemplate>
                    <div class="title" style="font-size:12px; font-weight:bold; padding-left:10px;"><%#Eval("subject") %></div>
                  
                      <div class="contents" style="text-align: justify; padding-left:15px;">   <asp:Label ID="Label2" runat="server" Text=<%#Server.HtmlDecode( Eval("description").ToString()) %> ></asp:Label>
                    </div>
                  <br />
                    </ItemTemplate>
                    </asp:DataList>
                    <center>
                        <asp:Label ID="Label1" runat="server" Text="Special offers will be updated soon"></asp:Label>
                    </center>
                </div>
                <!-- End of Right Nav	-->
